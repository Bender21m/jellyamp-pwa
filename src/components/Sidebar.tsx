...
import SidebarPlaylists from './sidebar/SidebarPlaylists'
...
export default function Sidebar() {
  ...
  function handleDropToast(message: string) {
  ...
  return (
    <aside 
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0">
        ...
        {!archiveOnly && <SidebarPlaylists onDropToast={handleDropToast} />}

        {/* Favorite Artists section */}
        {!archiveOnly && <SidebarFavorites />}
