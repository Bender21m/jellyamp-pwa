    ...
    <div className="relative overflow-hidden rounded-lg">
      ...
      {onContextMenu && (
        <button
          ...
          className="min-w-[44px] min-h-[44px] flex items-center justify-center shrink-0 text-white/70 hover:text-white transition-colors rounded-md hover:bg-white/5 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100 focus-visible:ring-2 focus-visible:ring-neon-cyan/50 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
